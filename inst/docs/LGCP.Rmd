...
Rate of murders per $\text{km}^2$ across NZ is calculated as `r round(spatial_murder_rate,4)`; there are roughly `r round(temporal_murder_rate,3)` per year. The spatio-temporal murder rate across NZ 2004--2019 is `r round(st_murder_rate,6)` (rate per $\text{km}^2$ per year).
...
```{r stelfi spatiotemp, eval = FALSE}
## Spatiotemporal
