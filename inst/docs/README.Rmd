...
text(as.numeric(difftime(day2,min(time),unit = "hours")) - 1,150,"24hrs since tweet",srt = 90)
abline(v = as.numeric(difftime(day3,min(time),unit = "hours")))
text(as.numeric(difftime(day3,min(time),unit = "hours")) - 1,150,"48hrs since tweet",srt = 90)
par(mar = c(2,5,0,2))
## hist
